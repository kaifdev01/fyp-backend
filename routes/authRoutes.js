...
const { register, login, verifyOTP, resendOTP, completeProfile, completeFreelancerProfile, completeOAuthProfile, oauthLogin, getMe, switchRole } = require('../controllers/authController');
